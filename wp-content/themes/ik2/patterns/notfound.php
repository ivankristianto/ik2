 ...
 * Title: 404 — Not Found
 * Slug: ik2/notfound
 * Description: Terminal-flavoured 404 with diagnostic stats and route suggestions.
 *
 * @package IK2
 */
...
?>
<!-- wp:group {"tagName":"main","className":"container-full ik-section","layout":{"type":"default"}} -->
<main class="wp-block-group container-full ik-section">
	<!-- wp:html -->
	...
	<!-- wp:buttons {"className":"ik-404__cta-row"} -->
	<div class="wp-block-buttons ik-404__cta-row">
		<!-- wp:button {"style":{"border":{"radius":"0.375rem"}}} -->
		<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/' ) ); ?>" style="border-radius:0.375rem">Go home</a></div>
		<!-- /wp:button -->

		<!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"0.375rem"}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/articles' ) ); ?>" style="border-radius:0.375rem">Browse articles</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</main>
