        ...
        <div className="ik-resume__exp">
          {data.experience.map((e, i) => (
            <div className="ik-resume__exp-row" key={i}>
              <div className="ik-resume__exp-when">{e.from}–{e.to}</div>
              <div className="ik-resume__exp-body">
                <div className="ik-resume__exp-role">{e.role} · <span>{e.org}</span></div>
                <div className="ik-resume__exp-note">{e.note}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="ik-resume__skills">
          {data.skills.map((s, i) => (
            <div className="ik-resume__skill" key={i}>
              <div className="ik-resume__skill-group">{s.group}</div>
              <ul>
