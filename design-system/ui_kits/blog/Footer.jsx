		...
		<footer className="ik-footer">
			<div className="container-full ik-footer__inner">
				<div className="ik-footer__brand">
					<div className="ik-footer__name">
						Ivan Kristianto<span>.</span>
					</div>
					<div className="ik-footer__tagline">
			...
			<div className="container-full ik-footer__bottom">
				<span>
					© 2026 · Built on WordPress · Theme based on the Ink,
					Paper, Signal design system.
				</span>
