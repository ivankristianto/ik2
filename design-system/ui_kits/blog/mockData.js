...
window.MOCK = {
	...
	notes: [
		{
			date: '2026-04-12',
			title: 'Switched the blog to a system-font stack — instant render, no FOUT',
			tags: [ 'performance' ],
		},
		{
			date: '2026-03-30',
			title: 'A tiny CLI to invalidate Cloudflare cache from a deploy hook',
			tags: [ 'cli', 'cloudflare' ],
		},
		{
			date: '2026-03-04',
			title: 'Reading: The Pragmatic Engineer on AI in the dev loop',
			tags: [ 'notes', 'ai' ],
		},
		{
			date: '2026-02-18',
			title: 'WordPress 6.7 + PHP 8.3 + LiteSpeed: re-tested every guide',
			tags: [ 'wordpress' ],
		},
		{
			date: '2026-01-22',
			title: 'Cleaned up my dotfiles repo — moved everything to chezmoi',
			tags: [ 'linux' ],
		},
	],
	...
	article: {
		...
		intro: "WordPress is an open-source project developed by a community from all over the world. A lot of experts spend their time making it as secure as possible — but I'm not in the position to say it has bulletproof security. You can see a few vulnerabilities have been reported, fixed, and disclosed via the WordPress HackerOne program. You can report one too: if it's valid, you'll get a bounty.",
		body: [
			{ kind: 'h2', text: 'Start with the boring stuff' },
			{
				kind: 'p',
				text: 'Most WordPress sites I audit are not breached because of a clever zero-day. They are breached because something boring was left undone: a stale plugin, a weak admin password, a forgotten staging environment indexed by Google.',
			},
			{
				kind: 'p',
				text: 'So before any of the more interesting steps below, do these three things.',
			},
			{
				kind: 'ol',
				items: [
					'Update core, themes, and plugins.',
					'Delete plugins and themes you are not using — yes, even the default ones.',
					'Force every admin account onto 2FA, not just yours.',
				],
			},
			{ kind: 'h2', text: 'Lock the login page' },
			{
				kind: 'p',
				text: 'The login page is the front door. Two changes make it noticeably harder to brute-force:',
			},
			{
				kind: 'pre',
				text: "# In wp-config.php\ndefine( 'WP_DISABLE_FILE_EDIT', true );\ndefine( 'DISALLOW_FILE_MODS', true );",
			},
			{
				kind: 'callout',
				variant: 'note',
				title: 'Note',
				text: 'If you use a managed host, check whether these constants are already set — some hosts override your wp-config.',
			},
			{
				kind: 'p',
				text: "Then add a rate-limiter at the edge. I use Cloudflare's Rate Limiting rules. The free tier is enough for a personal site.",
			},
			{ kind: 'h2', text: 'Harden file permissions' },
			{
				kind: 'p',
				text: 'After deployment, your tree should look something like this:',
			},
			{
				kind: 'pre',
			...
			},
			{
				...
				variant: 'outdated',
				title: 'Outdated · 2018',
				text: 'If you are reading this on the 2026 redesign, I have re-tested the steps and they still work. The Cloudflare UI has moved around a bit — links in this post point at the current dashboard.',
			},
			{ kind: 'h2', text: 'Watch the logs' },
			{
				kind: 'p',
				text: "None of the above matters if you do not look at your logs. Set up a daily digest — Logwatch, a basic cron job, or your host's built-in alerts. You want to notice unusual POST traffic to wp-login.php before someone else does.",
			},
		],
	},
		...
		experience: [
			{
				...
				from: '2024',
				to: 'Present',
				note: 'Enterprise WordPress, editorial tooling, performance work for large publishers.',
			},
			{
				role: 'Senior Web Engineer',
				org: '10up',
				from: '2018',
				to: '2024',
				note: 'Custom WordPress for newsrooms and enterprise. Performance audits, Gutenberg block libraries.',
			},
			{
				role: 'Lead Organiser',
				...
				from: '2017',
				to: '2017',
				note: 'Lead organiser for the largest WordCamp held in Indonesia (so far).',
			},
			{
				role: 'Lead Organiser',
				org: 'Jakarta WordPress Meetup',
				from: '2015',
				to: 'Present',
				note: 'Monthly meetup. Talks, workshops, and a community that ships.',
			},
		],
		skills: [
			{
				group: 'WordPress',
				items: [
					'Core, REST API, Gutenberg blocks',
					'Multisite, VIP-style scale',
			...
			},
			{
				...
				items: [
					'AI in the dev loop',
					'Talks: WordCamp, Google IO recaps',
